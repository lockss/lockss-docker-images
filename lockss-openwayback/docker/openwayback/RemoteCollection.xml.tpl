  ...
  <bean id="remotecollection" class="org.archive.wayback.webapp.WaybackCollection">
    ...
    <property name="resourceStore">
      <bean class="org.archive.wayback.resourcestore.SimpleResourceStore">
        <property name="prefix" value="http://${REPO_AUTH}@${REPO_HOST}:${REPO_REST_PORT}/wayback/warcs/" />
      </bean>
    </property>

    <property name="resourceIndex">
      <bean class="org.archive.wayback.resourceindex.RemoteResourceIndex">
        <property name="searchUrlBase" value="http://${REPO_AUTH}@${REPO_HOST}:${REPO_REST_PORT}/wayback/cdx/owb/${OPENWB_COLLECTION}" />
      </bean>
    </property>
  </bean>
